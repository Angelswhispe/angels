  ...
  return (
    <>
      <div className="lg:h-80 h-40 ">
        <div className="p-7 bg-[#000000]  opacity-70  w-[88%] lg:w-[60%] lg:ml-[20%] ml-6  text-white lg:text-lg  lg:h-96 h-[155%] text-[65%] font-bold">
          <h1 className=" text-center text-sm text-orange-200 -top-2 relative">WHAT'S ANGEL'S WHISPER?</h1>
          <p className="lg:w-[74%] font-sans lg:left-32 relative">
          ...
          <p className="mt-6 font-sans lg:w-[74%] lg:left-32 relative">
